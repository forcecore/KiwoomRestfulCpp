...
BEGIN_MESSAGE_MAP(CKiwoomRestfulCppApp, CWinApp)
...
CKiwoomRestfulCppApp::CKiwoomRestfulCppApp()
{
	...
	app->port(10000);
	AfxBeginThread(CrowThreadProc, (LPVOID) app);
}


// 유일한 CKiwoomRestfulCppApp 개체입니다.

CKiwoomRestfulCppApp theApp;


// CKiwoomRestfulCppApp 초기화

BOOL CKiwoomRestfulCppApp::InitInstance()
{
